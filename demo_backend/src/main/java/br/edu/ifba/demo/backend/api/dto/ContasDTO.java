...
public class ContasDTO {
    ...
    public ContasDTO(long idcontas, String descricao, float valor, Date datavencimento, Date datapagamento, String tipoconta, boolean statuscontas, Long idusuario, Long idcategoria){
        super();
